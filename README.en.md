...
For detailed deployment guide and system requirements, please see the [Deployment Guide](myportal/deploy.html). For student devices on the same LAN, replace `localhost` with the teacher's LAN IP address.
