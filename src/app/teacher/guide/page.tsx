  ...
  },
  {
    ...
    items: [
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, lineHeight: 1.8, fontSize: "0.938rem", color: '#475569' }}>
        ...
        <div><strong>实时消息引导</strong>：工具栏「发通知」可向全班发送引导提示，学生卡片上的「发消息」按钮可单独联系某位学生。消息将在学生端右下角气泡展示，学生可关闭。</div>
      </div>,
    ],
  },
  {
    ...
    items: [
      ...
      <><strong>提问频率控制</strong>：限制每位学生每分钟的提问次数，防止刷屏干扰，被拦截的违禁内容不计入次数。</>,
      <><strong>违禁词库</strong>：系统内置多类屏蔽词库，在学生发送消息时自动拦截。系统词和自定义词可分别一键开启或禁用。</>,
      <><strong>自定义规则</strong>：可自由添加自定义屏蔽词，灵活管控课堂言论。</>,
      <div>切换至「<Highlight>拦截记录</Highlight>」标签，可查看学生触发屏蔽词的完整记录：</div>,
      <><strong>详情追溯</strong>：按课堂汇总拦截次数，每条记录包含学生姓名、触发时间、原文内容，匹配的屏蔽词自动高亮标记。</>,
      <><strong>记录管理</strong>：支持单条删除和课堂级一键清空。拦截记录与学生对话数据独立，删除不影响聊天历史。</>,
    ],
  },
  {
